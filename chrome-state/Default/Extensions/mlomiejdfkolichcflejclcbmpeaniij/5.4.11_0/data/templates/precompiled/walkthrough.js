...
var _header = require('tpl/_header'),
	...
	_ghostrank = require('tpl/_ghostrank2'),
...
'\n\t\t\t</label>\n\t\t</p> -->\n\n\t\t<p>\n\t\t\t<button id="ghostrank-off" class="button ghostrank-button" aria-label="enable ghostrank">\n\t\t\t\t<span>'+
((__t=( t('walkthrough_ghostrank_disable') ))==null?'':_.escape(__t))+
'</span>\n\t\t\t</button>\n\t\t\t<button id="ghostrank-on" class="button ghostrank-button" aria-label="disable ghostrank">\n\t\t\t\t<span>'+
((__t=( t('walkthrough_ghostrank_enable') ))==null?'':_.escape(__t))+
...
'\n\t\t</p>\n\t</div>\n\n</div>\n\n<div class="options-div">\n\t<div id="navigation">\n\t\t<button id="nav-prev" class="button" tabindex="1" role="navigation" aria-label="previous section" style="display:none">\n\t\t\t<span>'+
((__t=( t('nav_back') ))==null?'':_.escape(__t))+
'</span>\n\t\t</button>\n\t\t<button href="#" id="nav-next" class="button" tabindex="1" role="navigation" aria-label="next section">\n\t\t\t<span>'+
((__t=( t('nav_next') ))==null?'':_.escape(__t))+
'</span>\n\t\t</button>\n\t</div>\n</div>\n\n<div class="options-div">\n\t'+
